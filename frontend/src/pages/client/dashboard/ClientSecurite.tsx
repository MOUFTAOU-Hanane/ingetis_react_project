    ...
    return (
        <div className="border rounded-lg p-4">
            ...
            <div className="mt-3 space-y-3">
                <button onClick={toggleModal} className="text-yellow-600 hover:text-yellow-800 block">
                    Changer de mot de passe
                </button>
                {/* <button className="text-yellow-600 hover:text-yellow-800 block">
                ...
                <div className="fixed inset-0 flex items-center justify-center backdrop-blur-xs bg-opacity-25">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96 relative">
                        ...
                        <form onSubmit={formik.handleSubmit} className="space-y-4">
                            ...
                            <button type="submit" className="w-full bg-yellow-600 text-white p-2 rounded-lg hover:bg-yellow-700">
                                Modifier
                            </button>
                        </form>
                    </div>
