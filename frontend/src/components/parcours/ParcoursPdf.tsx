        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>Parcours généré le {currentDate}</Text>
                </View>
                ...
                <View style={styles.content}>
                    ...
                    {parcours.lieux.map((lieu, index) => (
                        <View key={index} style={styles.lieuContainer}>
                            <Text style={styles.lieuNumber}>Étape {index + 1}</Text>
                    ...
                    <View style={styles.stats}>
                        ...
                        <Text style={styles.statsText}>• Parcours : {parcours.nom}</Text>
                        <Text style={styles.statsText}>
                ...
                <Text style={styles.footer}>
                    Parcours "{parcours.nom}" - Généré automatiquement par EventCulture
                </Text>
            </Page>
        </Document>
    );
