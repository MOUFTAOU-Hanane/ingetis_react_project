...
import CreateUser from "./pages/admin/users/create/CreateUser";
import LieuxList from "./pages/admin/lieux/list/LieuxList";
import CreateLieu from "./pages/admin/lieux/create/CreateLieu";
import AddParcours from "./pages/admin/parcours/create/AddParcours";
import ParcoursList from "./pages/admin/parcours/list/ParcoursList";
...
const routes: AppRoute[] = [
    ...
    { path: "/admin/lieux", element: <LieuxList />, allowedRoles: [ROLES.ADMIN, ROLES.ORGANISATEUR] },
    { path: "/admin/lieux/create", element: <CreateLieu />, allowedRoles: [ROLES.ADMIN, ROLES.ORGANISATEUR] },
    { path: "/admin/lieux/update/:id", element: <CreateLieu />, allowedRoles: [ROLES.ADMIN, ROLES.ORGANISATEUR] },
    { path: "/admin/lieux/:id/parcours/create", element: <AddParcours />, allowedRoles: [ROLES.ADMIN, ROLES.ORGANISATEUR] },
    { path: "/admin/lieux/:id/parcours", element: <ParcoursList />, allowedRoles: [ROLES.ADMIN, ROLES.ORGANISATEUR] },
